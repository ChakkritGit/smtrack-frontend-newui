  ...
  return (
    <div className='max-w-[720px] mx-auto py-14 px-5'>
      <div className='flex items-center justify-center'>
        <span className='text-[24px] font-normal'>Privacy & Policy</span>
      </div>
      <div className='mt-7'>
        <span className='text-base font-bold'>Privacy Policy</span>
        <br />
        <span>
          This privacy policy applies to the SMTrack+ app (hereby referred to as
          "Application") for mobile devices that was created by SIAMATIC COMPANY
          LIMITED (hereby referred to as "Service Provider") as a Free service.
        ...
        <br />
        <span>
          he Application collects information when you download and use it. This
        ...
        <span>
          ...
          of your mobile device. The Service Provider may use the information
          you provided to contact you from time to time to provide you with
          important information, required notices and marketing promotions. For
          a better experience, while using the Application, the Service Provider
        ...
        <div className='h-5'></div>
        <span className='text-base font-bold'>Third Party Access</span>
        <br />
        <span>
        ...
        <ul className='list-disc pl-5'>
          <li>
            Google Play Services The Service Provider may disclose User Provided
        ...
        <div className='h-5'></div>
        <span className='text-base font-bold'>Opt-Out Rights</span>
        <br />
        <span>
        ...
        <div className='h-5'></div>
        <span className='text-base font-bold'>Data Retention Policy</span>
        <br />
        <span>
          ...
          Application, please contact them at siamatic.thanesgroup@gmail.com and
        ...
        <span>
          ...
          the Service Provider (siamatic.thanesgroup@gmail.com) so that they
        ...
        <div className='h-5'></div>
        <span className='text-base font-bold'>Your Consent</span>
        <br />
        <span>
