  ...
  return (
    <div className='flex flex-col gap-2 py-3 pl-3 pr-2'>
      ...
      <button
        ...
        className={`flex items-center justify-between p-2 rounded-box hover:bg-base-200 cursor-pointer ${themeMode === '' ? 'bg-base-300/50' : ''}`}
      ...
      {themeList.map(theme => (
        <button
          ...
          className={`flex items-center justify-between p-2 rounded-box hover:bg-base-200 cursor-pointer ${theme === themeMode ? 'bg-base-300/50' : ''}`}
