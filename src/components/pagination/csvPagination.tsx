...
const CsvPaginationProps = <T,>({
  data,
  initialPerPage,
  renderItem,
  itemPerPage
}: CsvPaginationProps<T>) => {
  ...
  return (
    <>
      <div className='flex flex-col gap-1 md:max-h-[calc(100dvh-300px)] md:min-h-[calc(100dvh-300px)] md:overflow-y-scroll'>
...
export default CsvPaginationProps
