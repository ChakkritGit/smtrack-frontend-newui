              ...
              <div className='flex md:hidden flex-col items-center justify-center gap-3 mt-4 w-full'>
                ...
                <label className='flex items-center justify-center gap-2 w-full'>
                  <button
                    ...
                    onClick={() => {
                      if (
                        ...
                        (probeFiltered?.type?.split("|")[0] === 'PT100' ? -180 : -40)
                      ) {
                        setAdjustmentsForm({
                          ...adjustmentsForm,
                          tempMin: parseFloat(
                  ...
                  <input
                    ...
                    type='number'
                    step={0.01}
                    min={probeFiltered?.type?.split("|")[0] === 'PT100' ? -180 : -40}
                    max={probeFiltered?.type?.split("|")[0] === 'PT100' ? 200 : 120}
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (
                        adjustmentsForm.tempMin <
                        (probeFiltered?.type?.split("|")[0] === 'PT100' ? 200 : 120)
                      ) {
                        setAdjustmentsForm({
                          ...adjustmentsForm,
                          tempMin: parseFloat(
